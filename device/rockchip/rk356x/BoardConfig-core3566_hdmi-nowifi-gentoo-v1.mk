...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=luckfox_rk3566
# Uboot image format type: fit(flattened image tree)
export RK_UBOOT_FORMAT_TYPE=fit
# Kernel defconfig
export RK_KERNEL_DEFCONFIG=luckfox_core3566_nowifi_linux_defconfig
# Kernel defconfig fragment
export RK_KERNEL_DEFCONFIG_FRAGMENT=
# Kernel dts
export RK_KERNEL_DTS=core3566-hdmi-lp4x-v1-linux
# boot image type
